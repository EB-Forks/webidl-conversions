...
function isObject(V) {
    ...
    switch (typeof V) {
        ...
        default:
            ...
            // ones for uncallable non-standard exotic objects. Yet Type(), which the WebIDL spec depends on,
            // returns Object for such cases. So treat the default case as an object.
            return true;
    }
}
